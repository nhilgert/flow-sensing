...
set(c, 'TickLabels', {'< -0.015', '-0.01', '-0.005', '0', '0.005', '0.01', '> 0.015'});
set(gca, 'XTick', [0:11], 'XTickLabel', [-1:10], 'FontSize', fsize) % 10 ticks
set(gca, 'YTick', [1:22], 'YTickLabel', [10:-1:-10], 'FontSize', fsize)
